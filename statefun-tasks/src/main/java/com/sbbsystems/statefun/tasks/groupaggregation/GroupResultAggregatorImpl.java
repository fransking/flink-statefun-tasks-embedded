...
public class GroupResultAggregatorImpl implements GroupResultAggregator {
    private GroupResultAggregatorImpl() {
    }

    public static GroupResultAggregatorImpl newInstance() {
        return new GroupResultAggregatorImpl();
    }
